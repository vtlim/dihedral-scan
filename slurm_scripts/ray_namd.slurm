...
# m-c1.9   1.9GHz AMD       48                  0.5
# ilg2.3   2.3GHz AMD       32(64)              0.7
# nes2.8   2.8GHz Intel     8(16)-12(24)        1.0
# has2.5   2.5GHz Intel     24(48)
# brd2.4   2.4GHz Intel     28(56)
#
...
#
# MAKE SURE TO EDIT THE NAMD p value to be numNodes * 2 tasksPerNode * 8 cpusPerTask
#--------------
#SBATCH --nodes=1
# SBATCH --nodes=16
...
# Purge any inherited environment variables
#--------------
##SBATCH --export=NONE
#-------------- 

######################################################################
########## NO MORE SBATCH DIRECTIVES AFTER THIS POINT! ###############
######################################################################
...
# SLURM_ARRAY_JOB_ID         Job arrayâs master job ID number.
# SLURM_JOB_CPUS_PER_NODE    Count of processors available to the job on this node.
# SLURM_JOB_ID                The ID of the job allocation.
# SLURM_JOB_NAME             Name of the job.
# SLURM_JOB_NODELIST         List of nodes allocated to the job.
# SLURM_JOB_NUM_NODES        Total number of nodes in the jobâs resource allocation.
